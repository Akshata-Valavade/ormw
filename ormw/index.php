...
<html lang="en">
    <head>
        ...
        <title>Online result manifestation</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('images/result1.avif')">
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Online Result Manifestation</p></div>
        </footer>
        <!-- Bootstrap core JS-->
